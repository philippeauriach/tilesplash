...
Tilesplash.prototype.layer = function(name){
  ...
  this.server.get('/'+name+'/:z/:x/:y.:ext', function(req, res, throwError){
    ...
    render.query = function(data, options){
      gotTile(data, options);
    };
    render.queryFile = function(file, options){
      if(typeof options === 'string'){  //compatibility with old method, passing encoding directly
    ...
    render.rawFile = function(file, options){
      if(typeof options === 'string'){  //compatibility with old method, passing encoding directly
        options = {encoding: options};
      }
      options = options || {};
    ...
    var runQuery = function(structuredSql, options, done){
        ...
        sqlToGeojson(structuredSql[layer], function(err, geojson){
          if (err) {
            ...
            if(typeof options.postProcess === 'function') {
              geojson = options.postProcess(geojson, {layer: layer});
            }
    ...
    var gotTile = function(tileOutput, options){
      ...
      parseSql(tileOutput, function(parsingError, structuredSql){
        ...
        if (cacher) {
          ...
          self._cache(cacheKey, ttl, function(done){
            ...
            runQuery(structuredSql, options, function(queryError, layers){
